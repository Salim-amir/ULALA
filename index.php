...
new Chart(ctx, {
    ...
    options: {
        ...
        scales: {
            y:  { beginAtZero: true, position: 'left',  ticks: { callback: v => 'Rp ' + (v >= 1000000 ? (v/1000000).toFixed(1)+'jt' : (v/1000)+'rb'), font: { size: 10 } } },
            y1: { beginAtZero: true, position: 'right', grid: { drawOnChartArea: false }, ticks: { stepSize: 1, font: { size: 10 } } }
        }
    }
});
</script>
